    ...
    <footer className="bg-gray-800 text-white p-4 mt-8 ">
      <div className="container mx-auto text-center grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className=" grid grid-cols-1 md:grid-cols-1 gap-4 text-right">
          <div>
            ...
            <ul className="list-none space-y-1">
              <li>
                <a href="/about" className="hover:text-teal-500 text-white">
                  معلومات عنا
                </a>
              </li>
              <li>
                <a href="/contact" className="hover:text-teal-500 text-white">
                  اتصل بنا
                </a>
              </li>
            </ul>
        ...
        <div>
          ...
          <ul className="list-none space-y-1">
            <li>
              <a href="/policies" className="hover:text-teal-500 text-white">
                سياسة الخصوصية
              </a>
            </li>
          </ul>
